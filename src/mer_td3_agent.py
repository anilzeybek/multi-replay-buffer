...
class MERTD3Agent:
    ...
    def _sample(self, batch_size):
        ...
        total_stored = intermediate_rb_stored + rb0_stored + rb1_stored

        samples_intermediate = self.intermediate_rb.sample(batch_size * intermediate_rb_stored // total_stored)
        samples_rb0 = self.rb0.sample(batch_size * rb0_stored // total_stored)
        samples_rb1 = self.rb1.sample(batch_size * rb1_stored // total_stored)
